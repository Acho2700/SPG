...
class Axe(Bullet):
    def __init__(self, owner, target_pos, speed=12, damage=3):
        super().__init__(
            image_path='tempelates/Tank/axe.png',
            size=(80, 80),
        ...
        self.original_image = pygame.image.load('tempelates/Tank/axe.png').convert_alpha()
    ...
    def update(self, walls):
        ...
        if not self.is_returning:
            ...
            self.rect.centerx += return_dir.x * 5 * 1.5
            self.rect.centery += return_dir.y * 5 * 1.5
